            ...
            <div class="d-flex flex-column flex-column-fluid flex-center w-lg-50 p-10">
                ...
                <div class="d-flex justify-content-between flex-column-fluid flex-column w-100 mw-450px">
                    ...
                    <div class="d-flex flex-stack py-2">
                        ...
                        <!--begin::Sign Up link-->
                        <div class="m-0">
                            <span class="text-gray-500 fw-bold fs-5 me-2" data-kt-translate="sign-in-head-desc">Not have
                                an account?</span>
                            <a href="{{ route('users.signupForm') }}" class="link-primary fw-bold fs-5"
                    ...
                    <div class="py-20">
                        <!--begin::Form-->
                        <form class="form w-100"  action="{{ route('users.login') }}" method="POST">
                            @csrf
                            <!--begin::Body-->
                            <div class="card-body">
                                <!--begin::Heading-->
